...
- GitHub: open a private security advisory at
  https://github.com/ledger-nexus/fa-amort/security/advisories/new
...
- `docs/policies/data-subject-requests.md` — DSR procedure scoped to
  the fixed-asset register + depreciation data this repo holds
- `src/lib/privacy/fa-attribution.ts` — typed stub for the cross-repo
  attribution helper (counts only, never contents)

## Incident handling

Reports meeting the SEV-1/SEV-2 bar (unauthorized depreciation post,
asset-register exfiltration, vendor breach affecting capex source
data) follow the portfolio procedure in

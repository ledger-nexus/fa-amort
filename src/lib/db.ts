...
// listed in `src/lib/db/encrypted-fields-extension.ts`. In fa-amort
// that's `AiAssetSuggestion.inputText` (the free-form text fed to
// the AI capex classifier / impairment scorer) plus the READ side
// of `Party.displayName` (ledger-core writes, fa-amort joins via
// FixedAsset.vendor). Mirror of the same pattern in ledger-core
// and recon.
